                ...
                <div class="row">
                  <div class="col-sm-auto">
                    <div class="card border border-light">
                      <div class="card-header border border-white bg-primary"><b class="text-light">DAFTAR SEBAGAI ASISTEN</b></div>
            ...
            $.ajax({
              ...
              success: function(Respon){
                if (Respon == '1') {
                  ...
                  window.location = BaseURL + "IDE/Asisten"
                } else {
                  alert(Respon)
                  $("#LoadingInput").hide();
