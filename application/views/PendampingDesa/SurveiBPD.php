              <div class="row">
                <div class="col-sm-12">
                  <div class="card"> 
                    ...
                    <div style="background-color: yellow;" class="card-body border border-primary py-0 pl-1">
          ...
          if (Cek) {
            ...
            if (isNaN(parseInt($("#I10").val()))) {
              ...
              if (JumlahAspirasiMasyarakatMiskin > JumlahMasyarakatMiskin) {
                ...
                $.post(BaseURL+"PendampingDesa/InputBPD", BPD).done(function(Respon) {
                  if (Respon == '1') {
                    alert('Survei Berhasil Di Simpan!')
                    window.location = BaseURL + "PendampingDesa/SurveiBPD"
                  } else { 
                    alert(Respon)
                  }
                })
