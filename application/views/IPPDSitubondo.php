        ...
        <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
          ...
          <div class="panel panel-default">
            ...
            <div id="upload" class="panel-collapse collapse" role="tabpanel">
              <div class="panel-body">
                <a class="btn btn-primary btn-block" onclick="window.open('https://drive.google.com/drive/folders/1No92_NbtN_5DOGIXqowFexAHAOL9aAee?usp=drive_link')" role="button"> RENJA SKPD Tahun 2025</a>
                <a class="btn btn-primary btn-block" onclick="window.open('https://drive.google.com/drive/folders/186IY8jPfHb2yMvpHwXod_yLIUqA--wbR?usp=drive_link')" role="button">RENSTRA SKPD Tahun 2025-2029</a>
                <a class="btn btn-primary btn-block" onclick="window.open('https://drive.google.com/drive/folders/1KMFCTjJtioU80v4nXF-1ndemGCA2R-EH?usp=drive_link')" role="button">Rincian APBD Tahun 2024 & 2025</a>
                <a class="btn btn-primary btn-block" onclick="window.open('https://drive.google.com/drive/folders/1cpfFRZfoT05q-XG-sOnxY_T7CJShRe8D?usp=drive_link')" role="button">RKA SKPD Tahun 2024 & 2025</a>
                <a class="btn btn-primary btn-block" onclick="window.open('https://drive.google.com/drive/folders/18BaH26rpe_xs8nq2bI7xalDDX2TuefGl?usp=drive_link')" role="button">RKPD Tahun 2024 & 2025 (Murni dan Perubahan) </a>
                <a class="btn btn-primary btn-block" onclick="window.open('https://drive.google.com/drive/folders/1gLa2GzKXgsrN3KcDaJas3bsjt9GTutCn?usp=drive_link')" role="button">RPJMD Tahun 2025-2029</a>
              </div>
            </div>
          </div>
