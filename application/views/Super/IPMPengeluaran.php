              ...
              <div class="col-lg-12">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-3">
                    ...
                    <a href="<?=base_url('/Rekap/RekapDimensiPengeluaran.xlsx')?>" class="btn btn-sm btn-danger border-light"><b>Unduh Rekap</b></a>
                  </div>
                </div>
                <div class="row mt-2">
                  <div class="col-lg-3 col-sm-12 text-center">
                    ...
                    <div class="card-footer bg-danger border border-light p-0"><div class="font-weight-bold text-white" style="font-size: 15px;"><?="Rata-rata Pengeluaran<br>PerKapita Per Tahun ".number_format($PerKapita*100*12,0,",",".")?></div></div>
                    </div>
                  </div>
                  <div class="col-lg-3 col-sm-12 text-center">
                    <div class="card">
                      ...
                      <div class="card-footer bg-danger border border-light p-0"><div class="font-weight-bold text-white" style="font-size: 15px;"><?="Rata-rata Pengeluaran PerKapita<br>Konstan Per Tahun ".number_format($PerKapitaKonstan*100*12,0,",",".")?></div></div>
                    </div>
                  </div>
                  <div class="col-lg-3 col-sm-12 text-center">
                    <div class="card">
