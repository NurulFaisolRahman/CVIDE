<?php
  ...
  header('Content-Disposition: attachment; filename=ALHAMH_'.$NamaFile.'.xls');
?>
MIME-Version: 1.0
  ...
  <!--[if gte mso 9]>
   <xml>
    <o:DocumentProperties>
     ...
     <o:Created>2020-12-24T15:32:37</o:Created>
     <o:LastAuthor>WINDOWS 10</o:LastAuthor>
     <o:LastSaved>2021-01-01T12:48:29</o:LastSaved>
    </o:DocumentProperties>
...
.xl68
 ...
 <body link=3D"blue" vlink=3D"purple">
  <table width=3D"555" border=3D"0" cellpadding=3D"0" cellspacing=3D"0" style=3D'width:416.25pt;border-collapse:collapse;table-layout:fixed;'>
   <col width=3D"64" style=3D'width:48,00pt;'/>
   <col width=3D"75" span=3D"2" style=3D'mso-width-source:userset;mso-width-alt:2742;'/>
   <col width=3D"110" style=3D'mso-width-source:userset;mso-width-alt:4022;'/>
   <col width=3D"103" style=3D'mso-width-source:userset;mso-width-alt:3766;'/>
   <col width=3D"64" span=3D"2" style=3D'width:48,00pt;'/>
   <tr height=3D"20" style=3D'height:15.00pt;'>
    <td class=3D"xl65" height=3D"20" width=3D"64" style=3D'height:15.00pt;width:48.00pt;' x:str>Usia Ibu</td>
    <td class=3D"xl65" width=3D"75" style=3D'width:56.25pt;' x:str>Anak Lahir</td>
    <td class=3D"xl65" width=3D"75" style=3D'width:56.25pt;' x:str>Anak Mati</td>
    <td class=3D"xl65" width=3D"110" style=3D'width:82.50pt;' x:str>Anak Bertahan</td>
    <td class=3D"xl65" width=3D"103" style=3D'width:77.25pt;' x:str>Jumlah Ibu</td>
    <td class=3D"xl65" width=3D"64" style=3D'width:48.00pt;' x:str>ALH</td>
    <td class=3D"xl65" width=3D"64" style=3D'width:48.00pt;' x:str>AMH</td>
   </tr>
   <?php 
      $Rentang = array('15 - 19','20 - 24','25 - 29','30 - 34','35 - 39','40 - 44','45 - 49'); 
      for ($i=0; $i < count($ALHAMH); $i++) { ?>
        <tr height=3D"20" style=3D'height:15.00pt;'>
          <td class=3D"xl66" height=3D"20" style=3D'height:15.00pt;' x:str><?=$Rentang[$i]?></td>
          <td class=3D"xl67" x:num><?=$ALHAMH[$i][0]?></td>
          <td class=3D"xl67" x:num><?=$ALHAMH[$i][1]?></td>
          <td class=3D"xl67" x:num><?=$ALHAMH[$i][2]?></td>
          <td class=3D"xl67" x:num><?=$ALHAMH[$i][3]?></td>
          <td class=3D"xl67" x:num><?=$ALHAMH[$i][4]?></td>
          <td class=3D"xl67" x:num><?=$ALHAMH[$i][5]?></td>
        </tr>
    <?php } ?>
   <tr height=3D"20" style=3D'height:15.00pt;'>
    <td height=3D"20" style=3D'height:15.00pt;'></td>
    <td colspan=3D"3" style=3D'mso-ignore:colspan;'></td>
    <td class=3D"xl68" x:num><?=$Total[3]?></td>
