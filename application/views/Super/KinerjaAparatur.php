<style>
    ...
    .chart-container {
      width: 100%;
      height: 280px; /* Sedikit lebih tinggi karena ada 8 indikator */
    }
  </style>
      ...
      <div class="col-lg-5 mb-3">
        <div class="card card-dashboard h-100">
          <div class="card-header card-header-custom d-flex justify-content-between align-items-center py-2">
            <h6 class="m-0 text-primary" style="font-size: 14px;">Evaluasi Kinerja Aparatur</h6>
          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table table-sm table-hover table-striped table-custom mb-0">
                ...
                <tbody>
                  <?php $Indikator = array('Kepala Desa','Sekretaris Desa','Tata Usaha','Keuangan','Perencanaan','Pemerintahan','Kesejahteraan','Pelayanan'); 
                  ...
                  <tr class="highlight-row border-bottom">
                    ...
                    <td class="text-center h6 mb-0 text-success" style="font-size: 13px;"><?=$Kinerja[8]?></td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="col-lg-7 mb-3">
        <div class="card card-dashboard h-100">
          <div class="card-header card-header-custom py-2">
            <h6 class="m-0 text-secondary text-center" style="font-size: 13px;">Grafik Skor Kinerja Aparatur</h6>
          </div>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title font-weight-bold" style="font-size: 16px;">Kuisioner Evaluasi Kinerja Aparatur Desa</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body p-1">
          <embed src="<?=base_url('Kuisioner/KinerjaAparatur.pdf')?>" type="application/pdf" width="100%" height="450px"/>
        </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      function drawVisualization() {
        // Mengubah format data agar menjadi Bar Chart berwarna untuk 8 Indikator
        var data = google.visualization.arrayToDataTable([
          ['Indikator', 'Skor', { role: 'style' }],
          ['Kades',         <?=isset($Average[0]) ? $Average[0] : 0?>, '#4e73df'], // Biru
          ['Sekdes',        <?=isset($Average[1]) ? $Average[1] : 0?>, '#1cc88a'], // Hijau
          ['TU',            <?=isset($Average[2]) ? $Average[2] : 0?>, '#36b9cc'], // Cyan
          ['Keuangan',      <?=isset($Average[3]) ? $Average[3] : 0?>, '#f6c23e'], // Kuning
          ['Perencanaan',   <?=isset($Average[4]) ? $Average[4] : 0?>, '#e74a3b'], // Merah
          ['Pemerintahan',  <?=isset($Average[5]) ? $Average[5] : 0?>, '#858796'], // Abu-abu
          ['Kesejahteraan', <?=isset($Average[6]) ? $Average[6] : 0?>, '#5a5c69'], // Abu Gelap
          ['Pelayanan',     <?=isset($Average[7]) ? $Average[7] : 0?>, '#f86c6b']  // Coral Red
        ]);
        ...
        var options = {
          ...
          hAxis: {
            ...
            slantedText: true,
            slantedTextAngle: 45 // Memiringkan teks agar 8 label muat di layar
          },
          animation: {
            startup: true,
            duration: 1000,
