      ...
      <div class="col-lg-6 mb-3">
        <div class="card card-dashboard h-100">
          <div class="card-header card-header-custom d-flex justify-content-between align-items-center py-2">
            <h6 class="m-0 text-primary" style="font-size: 14px;">Evaluasi Kinerja PemDes</h6>
    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title font-weight-bold" style="font-size: 16px;">Kuisioner Evaluasi Kinerja Penyelenggaraan Pemerintahan Desa</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body p-1">
          <embed src="<?=base_url('Kuisioner/KinerjaPemDes.pdf')?>" type="application/pdf" width="100%" height="450px"/>
        </div>
