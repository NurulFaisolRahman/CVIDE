            ...
            <?php $Tahun = $this->session->userdata('TahunNTP'); ?>
              <div class="col-lg-12">
                ...
                <?php 
                  ...
                  $NamaPeternakan = array('Sapi Potong Lokal','Kambing','Itik/Bebek (Lokal)','Ayam Ras Pedaging ','Ayam Ras Petelur','Telur Itik/Bebek','Bibit Sapi (Umur < 2 Bulan)','Bibit Itik/Bebek','Bibit Sapi (Umur 2 Bulan s/d ≤ 12 Bulan)','Bibit Kambing (Umur 2 Bulan s/d ≤ 12 Bulan)','Bibit Ayam Ras Pedaging (Umur < 5 hari)/DOC','Bibit Ayam Ras Petelur (Umur < 5 hari)/DOC','Bibit Kambing > 1 Th','Vitamin ( B-12)','Garam','Antiseptika dan Desinfektansia','Analgesika/Anti Piretika/Antibiotika','Anti Fungi/Anti Jamur','Obat Diare','Anti Defisiensi Vitamin & Mine','Vaksin  (Ternak Besar)','Vaksin  (Unggas)','Dedak (Gabah)','Rumput','Jagung Pipilan','Pakan Jadi (Konsentrat)','Pur (Halus)','Pur (Kasar)','Ampas Tahu','Sewa Padang/Lahan Penggembalaan','Sewa Kandang Peternakan','Bensin (Pertalite)','Solar','Oli/Pelumas','Tarif Servis Motor (Ringan/Tune up)','Tarif Pulsa Ponsel (Paket Data )','Ember (Plastik)','Tempat Minum Unggas (Cap Globe)','Tempat Makan Unggas','Arit','Mesin Giling Pakan','Keranjang','Alat Penyemprot (Hand Sprayer )','Lemari Pendingin (Cold Storage )','Waring','Blower/Kipas','Drum','Bola Lampu','Gas LPG (3 Kg)','PDAM','Sekam','Jasa Kesehatan Ternak','Upah Pemeliharaan Ternak/Unggas (Laki-laki)','Upah Mencari Rumput ( Laki-laki)');
