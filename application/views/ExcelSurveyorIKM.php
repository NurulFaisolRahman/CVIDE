<?php
  ...
  header('Content-Disposition: attachment; filename='.$Surveyor.'.xls');
?>
MIME-Version: 1.0
  ...
  <!--[if gte mso 9]>
   <xml>
    <o:DocumentProperties>
     ...
     <o:Created>2020-12-04T11:08:44</o:Created>
     <o:LastAuthor>WINDOWS 10</o:LastAuthor>
     <o:LastSaved>2020-12-04T11:20:01</o:LastSaved>
    </o:DocumentProperties>
...
.xl65
     ...
     <x:ExcelWorksheets>
      <x:ExcelWorksheet>
       ...
       <x:WorksheetOptions>
        ...
        <x:StandardWidth>5302</x:StandardWidth>
        <x:Selected/>
        <x:Panes>
         <x:Pane>
          <x:Number>3</x:Number>
 ...
 <body link=3D"blue" vlink=3D"purple">
  <table width=3D"145" border=3D"0" cellpadding=3D"0" cellspacing=3D"0" style=3D'width:108.75pt;border-collapse:collapse;table-layout:fixed;'>
   <col width=3D"145" span=3D"16384" style=3D'mso-width-source:userset;mso-width-alt:5302;'/>
   <?php foreach ($IPM as $key) { $Pisah = explode("|",$key['NamaAnggota']); ?>
    <tr height=3D"26,67" class=3D"xl65" style=3D'height:20.00pt;mso-height-source:userset;mso-height-alt:400;'>
    <?php foreach ($Pisah as $Key => $Value) { ?>
      <td class=3D"xl65" height=3D"26,67" width=3D"145" style=3D'height:20.00pt;width:108.75pt;' x:str><?=$Value?></td>
    <?php } ?>
    </tr>
   <?php } ?>
