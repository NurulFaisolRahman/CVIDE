												...
												<?php $No = 1; foreach ($Kas as $key) { $Date = explode("-",$key['Tanggal']); ?>
													<tr>
														...
														<th scope="row" style="width: 10%;" class="text-center align-middle">
															<button Edit="<?=$key['Id']."|".$key['Description']."|".$key['Category']."|".$key['Amount']."|".$key['Tanggal']?>" class="btn btn-sm btn-warning Edit"><i class="fa fa-edit"></i></button>
            ...
            <div class="container">
							<div class="row">
								...
								<div class="col-sm-12">
									<div class="input-group input-group-sm mb-1">
										<div class="input-group-prepend">
                      <span class="input-group-text bg-primary text-white"><b>Kategori</b></span>
                    </div>
