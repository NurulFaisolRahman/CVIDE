...
<div class="admin-dashboard-hero">
  ...
  <div class="hero-content">
    <span class="hero-greeting-pill" id="dashboardGreetingPill">
      <i class="fa-solid fa-sun"></i> Selamat Datang, Admin IDE
    </span>
    <h1 class="hero-title">Enterprise Control Center</h1>
    <p class="hero-desc">
      Selamat bekerja kembali di Portal Administrator CV Inti Desain Ekonomi Consultant. Kelola laporan transaksi, pengeluaran proyek, dan jurnal keuangan perusahaan secara terpusat dan aman.
    </p>
  </div>
</div>
...
<script>
  $(document).ready(function(){
    ...
    // Dynamic Time Greeting for Admin Dashboard
