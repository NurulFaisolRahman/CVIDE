...
<html lang="id">
  <head>
    ...
    <style>
      ...
      .top_nav .nav_menu {
        background: linear-gradient(135deg, var(--ide-navy) 0%, #0a3d7c 100%) !important;
      ...
      /* Collapsed State Smooth Adjustments */
      ...
      .btn-danger:hover {
        background-color: #900610 !important;
      ...
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href="<?=base_url('Staf')?>"><i class="fa-solid fa-gauge-high"></i> <b>Dashboard</b> </a></li>
                </ul>
        ...
        <script>
          $(document).ready(function() {
            ...
            $(document).on('click', '.Hapus, .hapus, [Hapus], .btn-delete, .btn-hapus', function(e) {
