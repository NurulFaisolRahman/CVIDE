...
.slide-1 { 
  background-image: url('/CVIDE/assets/img/test1.webp');
...
.prog-v1 { background-image: url('assets/img/test1.webp'); }
  ...
  <div class="container">
    ...
    <div class="berita-grid">
      <div class="berita-featured">
        <div class="berita-featured-img" style="background-image: url('/CVIDE/assets/img/test1.webp');"></div>
      ...
      <div class="berita-list">
        <div class="berita-card">
          <div class="berita-thumb">
            <img src="/CVIDE/assets/img/test1.webp" alt="Berita 1" class="berita-thumb-img">
          </div>
        ...
        <div class="berita-card">
          <div class="berita-thumb">
            <img src="/CVIDE/assets/img/test1.webp" alt="Berita 2" class="berita-thumb-img">
          </div>
          <div class="berita-card-body">
        ...
        <div class="berita-card">
          <div class="berita-thumb">
            <img src="/CVIDE/assets/img/test1.webp" alt="Berita 3" class="berita-thumb-img">
          </div>
          <div class="berita-card-body">
        ...
        <div class="berita-card">
          <div class="berita-thumb">
            <img src="/CVIDE/assets/img/test1.webp" alt="Berita 4" class="berita-thumb-img">
          </div>
          <div class="berita-card-body">
  ...
  <div class="container">
    ...
    <div class="program-grid">
      ...
      <div class="program-card">
        <div class="program-visual" style="background-image: url('/CVIDE/assets/img/test1.webp'); background-size: cover; background-position: center;">
  ...
  <div class="container">
    ...
    <div class="galeri-grid">
      <div class="galeri-item">
        <div class="galeri-img" style="background-image: url('/CVIDE/assets/img/test1.webp');"></div>
