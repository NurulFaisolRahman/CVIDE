                ...
                <div class="row">
                  <div class="col-sm-auto">
                    <div class="card border border-light" style="width: 700px;">
                      <div class="card-header border border-white bg-primary"><b class="text-light">LIST ASISTEN YANG MENDAFTAR</b></div>
                          ...
                          <table class="table table-sm table-bordered bg-light" style="font-size: 12px;">
                            <thead>
                              <tr class="bg-danger text-light">
                                ...
                                <th scope="col" style="width: 30%;" class="align-middle">Nama Asisten</th>
                            ...
                            <tbody>
                              <?php $No = 1; foreach ($Asisten as $key) { ?>
                                <tr>
                                  <th scope="row" class="text-center align-middle"><?=$No++?></th>
                                  <th scope="row" class="align-middle"><?=$key['Nama']?></th>
                                  <th scope="row" class="align-middle text-center"><?=$key['WA']?></th>
                                  <th scope="row" class="text-center align-middle">
                                    <a href="../Asisten/<?=$key['CV']?>" download="CV <?=$key['Nama']?>" class="btn btn-sm btn-primary"><i class="fa fa-download"></i></button>
                                  </th>
                                </tr>
                              <?php } ?>  
                            </tbody>
