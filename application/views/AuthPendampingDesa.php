                ...
                <div class="row">
                  <div class="col-sm-auto">
                    <div class="card border border-warning">
                      <div class="card-header bg-danger"><b class="text-light">Pendamping Desa</b></div>
    ...
    <script>  
      jQuery(document).ready(function($) {
        ...
        $("#Masuk").click(function() {
          ...
          $.post(BaseURL+"IDE/AuthPendampingDesa", Akun).done(function(Respon) {
            if (Respon == '1') {
              window.location = BaseURL+"PendampingDesa"
            }
            else {
              alert(Respon)
            }
